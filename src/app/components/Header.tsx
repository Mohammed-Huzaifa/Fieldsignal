...
export const Header = () => {
  ...
  { label: "AI Fractional Leadership", href: "/services/ai-leadership" },
  { label: "AI KnowledgeStack", href: "/services/ai-knowledge-stack" },
  { label: "AI Agents (RAG + MCP)", href: "/services/ai-agents" },
  { label: "AI Governance + Guardrails", href: "/services/ai-governance" },
  { label: "AI Maintenance", href: "/services/ai-maintenance" },
  { label: "AI ContentEngine", href: "/services/ai-content-engine" },
  { label: "Visual AI", href: "/services/visual-ai" },
